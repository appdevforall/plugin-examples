...
| [`dependency-analysis/`](dependency-analysis/)     | Audits Gradle dependencies via the Dependency Analysis Gradle Plugin (`:buildHealth`) — reports unused, undeclared-transitive, and misconfigured deps and applies fixes in one tap. |
