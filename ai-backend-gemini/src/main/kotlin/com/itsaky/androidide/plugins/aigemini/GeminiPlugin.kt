...
class GeminiPlugin : IPlugin, DocumentationExtension {
    ...
    companion object {
        const val PLUGIN_ID = "com.itsaky.androidide.plugins.aigemini"
    ...
    override fun getTooltipEntries(): List<PluginTooltipEntry> = listOf(
        PluginTooltipEntry(
            ...
            detail = """
                <p><b>AI Gemini Backend</b> is a headless plugin that adds the
            ...
            buttons = listOf(
                PluginTooltipButton(
                    description = "AI Gemini Backend guide",
                    uri = "index.html",
                    order = 0
                )
            )
