#!/usr/bin/env bash
#
# Regenerate the prebuilt llama.cpp AAR consumed by the ai-backend-local plugin.
#
...
# Run from the ai-backend-local/ project root regardless of where it's invoked.
