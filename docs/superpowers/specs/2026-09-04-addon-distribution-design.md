...
| **O10** | **The six AI addons are skipped, so they do not publish.** PRD acceptance criterion 13 requires that they "still build and publish unchanged". | Two instructions conflict: the criterion says publish them, and the owner asked that they not be touched while other pull requests are in flight. Publishing them needs an `addon.json` and a rename, which is touching them. They stay skipped and the criterion is unmet until the owner says the other work has landed. |
