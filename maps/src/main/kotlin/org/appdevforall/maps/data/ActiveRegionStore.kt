...
internal object ActiveRegionStore {
     ...
     */
    fun read(projectDir: File, mapsSubpath: String): String? {
        readMarker(File(projectDir, "$mapsSubpath/$ACTIVE_REGION_FILE"))?.let { return it }
        return readMarker(File(projectDir, "$mapsSubpath/$REGION_MARKER_FILE"))
    }
     ...
     */
    fun write(projectDir: File, mapsSubpath: String, regionId: String) {
     ...
     */
    fun clear(projectDir: File, mapsSubpath: String) {
